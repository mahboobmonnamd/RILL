...
6. **Spike 0.** [SPIKE-0](docs/SPIKE-0.md) is Proven ([ADR 0010](docs/adr/0010-spike-0-closes.md)). Do not add agents, Blocks, or chrome to hide a later NFR miss. Chip 1 stays isolated until M4.
