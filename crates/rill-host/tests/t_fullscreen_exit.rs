...
//!
//! Bug (doc comment, not the name — ADR 0002 D6): after `make run` the
//! window is fullscreen; clicking the button to return to a normal window
//! hangs; force quit is required.
//!
