# ADR 0045: One Rust core, native UI per OS

- **Status:** Accepted — 2026-08-18
- **Amended by:** [ADR 0053](0053-runtime-domain-content-and-client-authority.md)
  D9. Product-required compositor and text boundaries are allowed while native
  platform presenters and the ban on speculative portable widgets remain.
- **Historical identifier:** merged as ADR 0027 in PR #278; renumbered to ADR
  0045 on 2026-08-21 with its series. Renumbering changed no decision.
...
- F-226 is effectively already met by the shipped macOS host and is tracked to
  the a11y and menu obligations in ADR 0044 D8.
