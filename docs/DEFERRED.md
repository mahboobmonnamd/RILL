...
| Workspace / durable Session / Tab / split tree / TerminalPane | Kernel nodes created at daemon bind; chrome projects Workspace id; persist/tabs/splits remain later | SPEC-DOMAIN-LIFECYCLE, SPEC-GRAPH, #341 |
